...
const Card = ({ post, classmain = "hp__col", layoutHorizontal=false, layoutVertical=false, layoutTitle=false, layoutFirst=false, descr=false }) => {
        ...
        <div className={classmain}>
            ...
            >
              ...
              <div className="news-out">
                <div
                className={
                  layoutVertical ? "news__top news__top--ver" : "news__top news__top--hor"
                }>
                  <div className={!layoutTitle?'news__top--image':'news__top--image news__top--hidden'}>
                      <GatsbyImage
                        alt={post.title}
                        objectFit='cover'
                        image={
                  ...
                  <div
                    className={
                      layoutVertical ? "news__withtag news__withtag--ver" : "news__withtag"
                  }>
