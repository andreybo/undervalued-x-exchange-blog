    ...
    <div className="tp">
      ...
      <div className="tp__inner container">
        ...
        <p>
          ...
          <strong>"Client"</strong>, <strong>“You”</strong> and{" "}
          <strong>“Your”</strong> refers to you, the person accessing this
          ...
          <strong>"Us"</strong>, refers to our Company. <strong>“Party”</strong>
          , <strong>“Parties”</strong>, or <strong>“Us”</strong>, refers to both
          ...
          of Croatia. Any use of the above terminology or other words in the
        ...
        <p>
          ...
          work-at-home opportunities, shall not be allowed to link); <br />
          ...
          <br />
          (b) does not falsely imply sponsorship, endorsement or approval of the
          linking party and it products or services;
          <br />
          (c) fits within the context of the linking party's site.
          <br />
          ...
          link. Allow up to 2weeks for a response.
          <br />
          ...
          <br />
          No use of (cname)’s logo or other artwork will be allowed for linking
        ...
        <p>
          ...
          <br /> (a) are subject to the preceding paragraph;
          <br />
          (b) govern all liabilities arising under the disclaimer or in relation
        ...
        <br />
        <p>Terms and Conditions were last modified on August 15th, 2016.</p>
        <h2>Contact us</h2>
        <br />
        <p>
